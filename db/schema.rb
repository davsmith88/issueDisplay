...
ActiveRecord::Schema.define(version: 20140526081540) do
  ...
  create_table "issues", force: true do |t|
    ...
    t.integer  "user_id"
    t.integer  "impact_id"
    t.integer  "DepartmentArea_id"
    t.date     "review_date"
  end

  add_index "issues", ["DepartmentArea_id"], name: "index_issues_on_DepartmentArea_id"
